...
public class LocalizationService : ILocalizationService
{
    ...
    private static readonly Dictionary<string, Dictionary<string, string>> AllStrings = new()
    {
        ["zh"] = new()
        {
            ...
            ["tray.preview"] = "预览当前摄像头",
            ["tray.today"] = "查看今日统计",
            ["tray.settings"] = "设置",
            ["tray.exit"] = "退出",
            ["tray.tooltip.camera_issue"] = "SeatTooLong - 摄像头异常",
            ["camera.preview.title"] = "当前摄像头预览",
            ["overlay.idle"] = "空闲",
            ["overlay.sitting"] = "已坐",
            ["overlay.absent"] = "离开",
            ["overlay.resting"] = "休息中",
            ["overlay.alert"] = "该起来活动了！",
            ["overlay.camera_issue"] = "摄像头异常",
        ...
        ["en"] = new()
        {
            ...
            ["tray.preview"] = "Preview Camera",
            ["tray.today"] = "Today's Stats",
            ["tray.settings"] = "Settings",
            ["tray.exit"] = "Exit",
            ["tray.tooltip.camera_issue"] = "SeatTooLong - Camera issue",
            ["camera.preview.title"] = "Current Camera Preview",
            ["overlay.idle"] = "Idle",
            ["overlay.sitting"] = "Sitting",
            ["overlay.absent"] = "Away",
            ["overlay.resting"] = "Resting",
            ["overlay.alert"] = "Time to stand up!",
            ["overlay.camera_issue"] = "Camera issue",
